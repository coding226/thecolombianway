			...
			<div class="fusion-flyout-menu-icons">
				...
				<?php if ( 'menu' === Avada()->settings->get( 'slidingbar_toggle_style' ) && Avada()->settings->get( 'slidingbar_widgets' ) ) : ?>
					...
					<div class="fusion-flyout-sliding-bar-toggle">
						<a href="#" class="fusion-toggle-icon fusion-icon fusion-icon-sliding-bar" aria-label="<?php echo esc_attr( $sliding_bar_label ); ?>">
							<span class="currentLang"><?php echo pll_current_language(); ?></span>
						</a>
					</div>
				<?php endif; ?>
