...
<div id="posts-container" class="fusion-blog-archive <?php echo esc_attr( $wrapper_class ); ?>fusion-clearfix">
	...
	<div class="fusion-layout-column fusion_builder_column fusion_builder_column_1_1 fusion-builder-column-1 fusion-one-full fusion-column-first fusion-column-last 1_1" style="margin-top:0px;margin-bottom:20px;width:100%">
		<div class="fusion-column-wrapper" style="padding: 0px; background-position: left top; background-repeat: no-repeat; background-size: cover; height: auto;" data-bg-url="">
			<div class="fusion-title title fusion-title-1 fusion-sep-none fusion-title-text fusion-title-size-two fusion-border-below-title" style="font-size:34px;margin-top:0px;margin-bottom:0px;">
				<h2 class="title-heading-left" style="margin:0;font-size:1em;">
					<?php echo sprintf( esc_html__( 'Search results for: %s', 'Avada' ), get_search_query() ); ?>
				</h2>
			</div>
		...
		<?php while ( have_posts() ) : ?>
			...
			<article id="post-<?php the_ID(); ?>" <?php post_class( $post_classes ); ?>>
				...
				<div class="fusion-post-content post-content">
					...
					<?php if ( 'grid' === $blog_layout || 'masonry' === $blog_layout || 'timeline' === $blog_layout ) : ?>
						<?php if ( is_search() && get_field('display_subtitles_in_search_results', 'option') && get_field('subtitle')): ?>
							<p class="fusion-single-line-meta mb10"><?php echo get_field('subtitle'); ?></p>
						<?php endif; ?>
